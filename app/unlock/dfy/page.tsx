...
export default function UnlockDFYPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/upgrades/unlock", {
        ...
        body: JSON.stringify({ email, upgradeType: "dfy" }),
      })
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6 relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        <motion.div
          className="absolute left-[20%] top-[20%] h-96 w-96 rounded-full bg-gradient-to-r from-yellow-500 to-amber-500 opacity-20 blur-3xl"
        ...
        {success ? (
          <Card className="glass-strong border-2 border-green-500/50">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-xl text-gray-300 mb-2"><strong>DFY Upgrade</strong> is now active!</p>
          ...
          <Card className="glass-strong border-2 border-white/20 animate-cyber-glow">
            <CardHeader className="text-center">
              <div className="mx-auto mb-4 rounded-full bg-gradient-to-br from-yellow-500 to-amber-500 p-4 w-20 h-20 flex items-center justify-center">
                <Crown className="h-10 w-10 text-white" />
              </div>
              <CardTitle className="text-3xl gradient-text-cyber mb-2">Unlock DFY Upgrade</CardTitle>
              <CardDescription className="text-lg text-gray-300">Enter your account email to activate done-for-you content</CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="rounded-lg border-2 border-white/10 p-6">
                ...
                <div className="space-y-3">
                  {["500+ pre-written comments", "200+ viral post templates", "Weekly content updates", "Proven money-making blueprints"].map((feature) => (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  ...
                  {loading ? "Unlocking..." : "Unlock DFY Upgrade"}
                </Button>
              </form>
            </CardContent>
          </Card>
